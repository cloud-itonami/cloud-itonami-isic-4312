# Operator Quickstart — Site Preparation

Shortest path from clone to a verified local dry-run for **ISIC 4312** (`cloud-itonami-isic-4312`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4312.git
cd cloud-itonami-isic-4312
```
...
- Blueprint governor key: `site-prep-governor`
- Likely source path: `site_prep.governor.cljc`
