# Business Model: Site Preparation
...
## Classification
- Repository: `cloud-itonami-isic-4312` ([github.com/cloud-itonami/cloud-itonami-isic-4312](https://github.com/cloud-itonami/cloud-itonami-isic-4312))
- ISIC Rev.5: `4312` — Site Preparation
- Domain: `:construction/site-preparation`
- Social impact: :worker-safety :utility-strike-prevention :land-redevelopment
- Actor: `:site-prep-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :construction/site-preparation — who wants
...
One managed tenant (:construction/site-preparation):
...
- Do not bypass the `:site-prep-governor` for production decisions.
